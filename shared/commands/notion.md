Genera o actualiza el reporte diario en la página semanal de Notion usando la skill `notion-weekly-report` y, si Notion no está disponible, hace fallback automático a Markdown local.
